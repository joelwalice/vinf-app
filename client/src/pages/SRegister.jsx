...
const SRegister = () => {
  ...
  const registerUser = async (e) => {
      ...
      await axios.post('https://vinf-app.vercel.app/seller/register', {name, email, password})
          .then((res) => {
    ...
    <div>
        ...
        <div className='w-screen md:w-[500px] lg:w-[500px] h-[500px] bg-pink-100 rounded-3xl p-4 '>
            <div>
                ...
                <form action="" className='flex flex-col justify-center pt-10 p-4 gap-5 items-center'>
